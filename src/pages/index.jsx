  ...
  <React.Fragment>
    <Parallax pages={5}>
      <Divider speed={0.2} offset={0}>
        <UpDown>
          <SVG icon="triangle" className={hidden} width={32} stroke={colors.orange} left="10%" top="20%" />
          <SVG icon="triangle" width={32} stroke={colors.red} left="60%" top="100%" />
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Kenneth Nguyen.
          </BigTitle>
          <Subtitle>I'm passionate about creating web apps and I am always learning.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
        bg="linear-gradient(to right, #1F8A70 0%, #1F8A70 100%)"
        speed={-0.2}
        offset={1.1}
        factor={2}
      />
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="EZ Cooking"
              link="http://www.ez-cooking.com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              This web app makes learning to cook new dishes interactive and fun.
            </ProjectCard>
            <ProjectCard
              title="Map It Up"
              link="https://mapit-up.herokuapp.com"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              The mobile web app that lets you save and share favorite locations with others in real time using emojis.
            </ProjectCard>
            <ProjectCard
              title="Idea Development Kit"
              link="http://idea-development-kit.herokuapp.com"
              bg="linear-gradient(to right, #009245 40%, #FCEE21 100%)"
            >
              A toolkit prototype to help teams brainstorm, review, and select ideas for their next projects!
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Kenneth Nguyen" />
            <AboutSub>
            <h2>UC San Diego</h2>
            <p>Graduation Date: June 2018</p>
            B.S. Cognitive Science with Specialization in Human Computer Interaction
            </AboutSub>
          </AboutHero>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            <p>Email: kdn004@ucsd.edu</p>
            <p>Phone: (408) 637-8645</p>
            {' '}
            <a href="https://www.linkedin.com/in/kennethdnguyen/">LinkedIn</a> &{' '}
            <a href="https://github.com/kennethdnguyen">Github</a>
          </ContactText>
        </Inner>
        <Footer>
